...
const DisabledMessageSendForm = () => {
    ...
    <div className="fixed right-0 bottom-0 w-full max-w-[600px] p-8 ">
        ...
        <input id="msg" name="msg" disabled type="text" className={`rounded-full p-3 text-xl w-full shadow-2xl flex accent-[#F35627] caret-[#F35627]`} placeholder="Select a channel first..."></input>
