...
const MessageSendForm = (props:{callbackRef:MutableRefObject<()=>void>, onSubmit:(e:FormEvent<HTMLFormElement>, session:string, callbackRef:MutableRefObject<()=>void>)=>Promise<boolean>, session:string}) => {
